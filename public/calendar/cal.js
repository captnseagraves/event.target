  ...
  $(document).ready(function() {
    ...
    $cal.responsiveCalendar({
      ...
      onActiveDayHover: function(events) {
        let $today, $dayEvents, $i, $isHoveredOver, $placeholder, $output;
  ...
  (function(c) {
    ...
    d.prototype = {
      ...
      drawDays: function(o, u) {
        let p, s, f, j, w, n, r, t, h, x, y, l, q, k, m, e, g, v;
        q = this;
        k = new Date(o, u);
        p = k.getMonth();
        y = k.getMonth() + 1;
        ...
        n = function() {
          ...
          i = function() {
            ...
            if (q.options.onActiveDayHover) {
              return q.$element.find('[data-group="days"] .day.active a').click(function() {
